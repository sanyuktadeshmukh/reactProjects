...
import ChatWindow from '../GeneralComponents/ChatWindow';
    ...
    return (
        <>
            ...
            }
            {
                chatWindow ?
                    <>
                        <ChatWindow setChatWindow={setChatWindow} email={clientEmail} userType={"client"} />
                    </> :
                    <></>
            }
            {
            ...
            <div id="ClientBoard">
                ...
                <div id="ClientProfile">
                    ...
                    <div className='dashDataImgDiv'>
                        ...
                        <img src='../IMAGES/Chat.png' alt="Not" className='chatDashImg' title='Chat' onClick={(e) => { setChatWindow (prev=>!prev)}}></img>
